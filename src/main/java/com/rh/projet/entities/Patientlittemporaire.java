...
public class Patientlittemporaire {
    ...
    public Patientlittemporaire() {
    }

    public Patientlittemporaire(int id, int idlit, int idpatient, Date date_entree_lit, Date date_sortie_lit, boolean status) {
        this.id = id;
        this.idlit = idlit;
