        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Attribuer Chambre</h4>
                  <form class="forms-sample" action="#" th:action="@{/save}" th:object="${docteur}" method="post">
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail3">Chambre</label>
                        <div class="input-group">
                          <div class="input-group-prepend">
                            <select class="btn btn-sm btn-outline-primary dropdown-toggle" id="cars" name="cars">
                                ...
                                <option value="Chambre4">Chambre 4</option>
                              </select>
                          </div>
                        </div>
                      </div>
