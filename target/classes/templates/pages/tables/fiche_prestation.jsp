                  ...
                  <div class="card-body">
                    <form class="form-inline">
                      ...
                      <div class="input-group mb-2 mr-sm-2">
                        <label for="exampleInputPassword4">Date Debut</label>
                    ...
                    <div class="input-group mb-2 mr-sm-2">
                        <label for="exampleInputPassword4">Nom Patient</label>
                      <input type="date" th:field="*{datedenaissance}" class="form-control" id="exampleInputPassword4">
                    </div>
                    <div class="input-group mb-2 mr-sm-2">
                        <label for="exampleInputPassword4">Numero de chambre</label>
                      <input type="date" th:field="*{datedenaissance}" class="form-control" id="exampleInputPassword4">
                    </div>
                    <div class="input-group mb-2 mr-sm-2">
                        <label for="exampleInputPassword4">Nom Medecin</label>
                      <input type="date" th:field="*{datedenaissance}" class="form-control" id="exampleInputPassword4">
                    </div>
            ...
            <div class="card">
              <div class="card-body">
                <form class="forms-sample"> 
                  <button type="submit" class="btn btn-primary mr-2">Generer PDF</button>
                </form>
              </div>
            </div>
          </div>
