                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                        <tr  th:each="docteur : ${listdocteur}">
                          ...
                          <td th:text="${docteur.id}">ID Chambre</td>
                          <td th:text="${docteur.nom}">Numero</td>
                          <td th:text="${docteur.niveau}">Lit Restant</td>
                          <td th:text="${docteur.nom}">Tarif</td>
                          <td th:text="${docteur.niveau}">Categorie</td>
                      <td>
                        <a th:href="@{'/edit/' + ${docteur.id}}"><label  class="badge badge-info">Edit</label></a>
                      </td>     
                      <td>  
                        <a th:href="@{'/delete/' + ${docteur.id}}"><label  class="badge badge-danger">Delete</label></a>
                      </td>     
                      </tr>
                      </tbody>
                    </table>
